...
import { getProducts } from "@/common/database";
import ProductPreviewCard from "@/common/components/ProductPreviewCard";
import {
  Chip,
  CircularProgress,
  CloseIcon,
...
import { ProductCategory, ProductWithId } from "@/common/types";
  ...
  return (
    <div className={"w-full min-h-[80dvh]"}>
      <Sheet
        ...
        className={
          "p-4 py-12 flex flex-col gap-8 max-w-full w-[500px] overflow-auto z-20"
        }
      >
        <IconButton
